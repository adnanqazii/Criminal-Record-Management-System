	...
	if ( *login>=1 && *login<=5 )
	{
		...
		{	
			...
			if ( i == 0 )
			{
				...
				printf( "\n\nChoose S.No of a Criminal to modify it's Record " );
				scanf( "%d", &i );
...
int del_most (void)
{
	...
	rename("data/temp.DAT","data/most.DAT");
	return 0;
}
